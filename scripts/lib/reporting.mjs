...
export function validateReport(value) {
  ...
  if (value.productPrPoints !== undefined && !Array.isArray(value.productPrPoints)) errors.push("productPrPoints must be an array");
  if (value.competitiveInsights !== undefined && !Array.isArray(value.competitiveInsights)) errors.push("competitiveInsights must be an array");
  if (value.unconventionalAngle !== undefined && value.unconventionalAngle !== null && typeof value.unconventionalAngle !== "object") errors.push("unconventionalAngle must be an object or null");
